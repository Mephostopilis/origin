    ...
    class MainController : Controller {
        ...
        public void OnSendMatch(EventCmd e) {
            if (((AppConfig)_ctx.Config).VERSION == AppConfig.VERSION_TYPE.TEST) {
                ...
                _ctx.SendReq<C2sProtocol.match>(C2sProtocol.match.Tag, null);
            }
        }
        ...
        public SprotoTypeBase OnMatch(SprotoTypeBase requestObj) {
            ...
            //    C2sSprotoType.join.request req = new C2sSprotoType.join.request();
            //req.roomid = obj.roomid;
            //_ctx.SendReq<C2sProtocol.join>(C2sProtocol.join.Tag, req);
