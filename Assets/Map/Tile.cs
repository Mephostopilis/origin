...
public class Tile : MonoBehaviour {
    ...
    private float corner0height;
    private float corner1height;
    private float corner2height;
    private float corner3height;
    private float corner4height;
    private float corner5height;
