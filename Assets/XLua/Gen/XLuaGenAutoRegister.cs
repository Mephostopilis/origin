    ...
    public class XLua_Gen_Initer_Register__
	{
	    static XLua_Gen_Initer_Register__()
        {
		    XLua.LuaEnv.AddIniter((luaenv, translator) => {
				...
				translator.DelayWrapLoader(typeof(Bacon.Game.GameController), BaconGameGameControllerWrap.__Register);
				...
				translator.DelayWrapLoader(typeof(Maria.Controller), MariaControllerWrap.__Register);
				...
				translator.DelayWrapLoader(typeof(Maria.Res.ABLoader), MariaResABLoaderWrap.__Register);
				
				translator.DelayWrapLoader(typeof(Maria.Service), MariaServiceWrap.__Register);
				...
				translator.AddInterfaceBridgeCreator(typeof(Bacon.Lua.ILuaGameController), BaconLuaILuaGameControllerBridge.__Create);
				
				translator.AddInterfaceBridgeCreator(typeof(Bacon.Lua.ILuaPool), BaconLuaILuaPoolBridge.__Create);
				
				translator.AddInterfaceBridgeCreator(typeof(Maria.Lua.ILuaActor), MariaLuaILuaActorBridge.__Create);
				
				translator.AddInterfaceBridgeCreator(typeof(Maria.Lua.ILuaClientSock), MariaLuaILuaClientSockBridge.__Create);
				
				translator.AddInterfaceBridgeCreator(typeof(Maria.Lua.ILuaContext), MariaLuaILuaContextBridge.__Create);
				
				translator.AddInterfaceBridgeCreator(typeof(Maria.Lua.ILuaController), MariaLuaILuaControllerBridge.__Create);
				
				translator.AddInterfaceBridgeCreator(typeof(Maria.Lua.ILuaModule), MariaLuaILuaModuleBridge.__Create);
				
				translator.AddInterfaceBridgeCreator(typeof(Maria.Lua.ILuaSystemContainer), MariaLuaILuaSystemContainerBridge.__Create);
